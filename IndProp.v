...
(** - Which of the following propositions are provable?
      - [R 1 1 2]: This is provable by c1, c2, and c3.
      - [R 2 2 6]: This is not provable

    - If we dropped constructor [c5] from the definition of [R],
      would the set of provable propositions change?  Briefly (1
      sentence) explain your answer. 
      
      Answer: No, the same goal could be accomplished by c1, c2, and c3.

    - If we dropped constructor [c4] from the definition of [R],
      would the set of provable propositions change?  Briefly (1
      sentence) explain your answer.

      Answer: No, c1, c2, then c3 will accomplish the same goal. 
...
Example reg_exp_ex3' : [1; 2; 3] =~ App (App (Char 1) (Char 2)) (Char 3).
Proof.
  apply (MApp [1;2] _ [3]).
  - apply (MApp [1] _ [2]).
    + apply MChar.
...
Proof.
  intros.
  inversion H.
  - apply (MUnionL s re1 re2). apply H0.
  - apply (MUnionR re1 s  re2). apply H0.
Qed.
...
Proof.
  ...
  - split.
    + inversion H. intros. destruct H0. apply H1.
    + intros. inversion H0.
Qed.
